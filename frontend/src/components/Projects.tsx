      ...
      <section id="projects" className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="animate-pulse">
            ...
            <div className="h-4 bg-slate-200 dark:bg-slate-700 rounded w-96 mx-auto mb-12"></div>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[1, 2, 3].map((i) => (
                <div
                  key={i}
                  className="h-96 bg-slate-200 dark:bg-slate-700 rounded-2xl"
                ></div>
              ))}
            </div>
          </div>
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="flex gap-3">
                  ...
                  <button className="p-2 rounded-lg bg-slate-100 dark:bg-slate-700 hover:bg-cyan-100 dark:hover:bg-cyan-900 transition-colors">
                    <Code2 size={18} />
                  </button>
                </div>
              </div>
