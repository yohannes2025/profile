...
EMAIL_USE_SSL = config('EMAIL_USE_SSL', default=False, cast=bool) # Must be False for Port 587

EMAIL_HOST_USER = config('EMAIL_HOST_USER', default='')
EMAIL_HOST_PASSWORD = config('EMAIL_HOST_PASSWORD', default='') # Must be 16-character Google App Password
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default=EMAIL_HOST_USER)
CONTACT_EMAIL = config('CONTACT_EMAIL', default=EMAIL_HOST_USER)

# CRITICAL TIMEOUT SAFEGUARD
# Prevents Django from hanging infinitely if Render blocks or delays the SMTP connection
EMAIL_TIMEOUT = 10
